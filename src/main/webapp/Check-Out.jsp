								...
								<div class="table-responsive">
									<table class="table">
										...
										<tbody>
											...
											while (res.next()) {
												session.setAttribute("searchoutemail", res.getString("email"));
											%>
											<tr>
												<td>
													<%
													out.println(res.getString("fname"));
													%>
												</td>
												<td>
													<%
													out.println(res.getString("lname"));
													%>
												</td>
												<td>
													<%
												...
												<td>
													<%
													out.println(res.getString("landmark"));
													%>
												</td>
												<td>
													<%
													out.println(res.getString("area"));
													%>
												</td>
												<td>
													<%
													out.println(res.getString("postalcode"));
													%>
												</td>
												<td>
													<%
													out.println(res.getString("gender"));
													%>
												</td>
												<td>
													<%
													out.println(res.getString("contactno"));
													%>
												</td>
												<td>
													<%
												...
												<td><a ID="HyperLink7"
													...
													href="checkoutdetails.jsp">Select</a></td>
											</tr>
											<%
											}
											}
